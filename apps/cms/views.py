...
@method_decorator(permission_required('news.add_news',login_url='/'),name='dispatch')
class WritreNewsView(View):
...
@method_decorator(permission_required('news.change_news',login_url='/'),name='dispatch')
...
def edit_news_category(request):
    ...
    if forms.is_valid():
        ...
        try:
            filterName = NewsCategory.objects.filter(pk=pk)
            getName = NewsCategory.objects.get(pk=pk)
        ...
        return restful.params_error(message=forms.errors)
...
def banner_list(request):
    ...
    serialize = BannerSerializers(banner,many=True)
...
@permission_required(perm='news.edit_banner',login_url='/')
